...
- (void) pushOrgProfileVCWithAutoOpenChat:(BOOL) autoOpenChat autoOpenChannelID:(NSInteger) autoOpenChannelID delegate:(id <WTSDKManagerDelegate>) delegate animated:(BOOL) animated;
